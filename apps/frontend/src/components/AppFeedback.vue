...
<style scoped>
.app-feedback { align-items: center; background: var(--surface-raised); border: 1px solid var(--line-strong); box-shadow: var(--feedback-shadow); display: flex; gap: 1rem; justify-content: space-between; left: 50%; max-width: min(32rem, calc(100vw - 2rem)); padding: 0.75rem 0.75rem 0.75rem 1rem; position: fixed; top: 1rem; transform: translateX(-50%); z-index: 20; }
