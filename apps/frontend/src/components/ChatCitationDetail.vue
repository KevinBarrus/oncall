...
<style scoped>
.chat-citation-detail { background: var(--context-panel-bg); border: 1px solid var(--line); border-radius: var(--radius-md); display: grid; gap: 0.85rem; max-width: 46rem; padding: 1rem; }
