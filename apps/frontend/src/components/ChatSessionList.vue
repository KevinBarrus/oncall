...
<style scoped>
.chat-session-list { background: var(--context-panel-bg); border-right: 1px solid var(--line); display: flex; flex-direction: column; min-height: 0; min-width: 0; overflow-y: auto; }
...
.chat-session-list--rail .chat-session-list__header button:hover, .chat-session-list--rail .chat-session-list__delete:hover { background: var(--rail-hover); color: var(--workspace-icon-active); }
...
.chat-session-list--rail .chat-session-list__select--active { background: var(--workspace-icon); color: var(--workspace-icon-active); }
.chat-session-list--rail .chat-session-list__select--active svg { color: var(--workspace-link-active); }
