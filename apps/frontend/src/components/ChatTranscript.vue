...
.chat-transcript__message-sources li button:hover { background: var(--citation-hover); }
...
.chat-transcript__context { background: var(--context-panel-bg); border: 1px solid var(--line); border-radius: var(--radius-md); max-width: 46rem; padding: 0.9rem 1rem; }
