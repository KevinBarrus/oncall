...
.markdown-content :deep(code) { background: var(--code-inline-bg); color: var(--code-inline-text); font-size: 0.88em; padding: 0.1rem 0.25rem; }
.markdown-content :deep(pre) { background: var(--code-block-bg); color: var(--code-block-text); overflow-x: auto; padding: 0.9rem; }
...
.markdown-content--report :deep(tr:nth-child(even) td) { background: var(--table-stripe); }
