...
.retrieval-stage-trace > div[data-stage="vector"] { border-left-color: var(--retrieval-vector); }
.retrieval-stage-trace > div[data-stage="bm25"] { border-left-color: var(--retrieval-bm25); }
