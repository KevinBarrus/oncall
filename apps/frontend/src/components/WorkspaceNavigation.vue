...
.workspace-navigation__link--active { background: var(--workspace-icon); color: var(--workspace-icon-active); font-weight: 650; }
.workspace-navigation__link--active svg { color: var(--workspace-link-active); }
</style>
