...
.aiops-view__center { background: var(--context-panel-bg); border-right: 1px solid var(--line); display: grid; grid-template-rows: auto minmax(0, 1fr) minmax(8rem, 0.42fr); overflow: hidden; }
