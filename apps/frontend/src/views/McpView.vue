...
.mcp-view__inspection { background: var(--context-panel-bg); }.mcp-view__check-summary { align-items: center; background: var(--status-success-bg); border: 1px solid var(--status-success-border); display: flex; gap: 0.65rem; margin-top: 1.2rem; padding: 0.75rem; }.mcp-view__check-summary--failed { background: var(--status-danger-bg); border-color: var(--status-danger-border); }.mcp-view__check-summary strong, .mcp-view__check-summary small { display: block; }.mcp-view__check-summary small { font-size: 0.7rem; margin-top: 0.15rem; }
